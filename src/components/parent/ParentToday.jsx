  ...
  return (
    <div className="fade-slide">
      ...
      <div className="parent-card">
        ...
        <div className="parent-card-sub">{profile.childName}{particle(profile.childName, "이", "가")} 완료를 알려온 퀘스트예요. 확인하고 승인해주세요.</div>
        <div style={{ marginTop: 4 }}>
      ...
      {retryTargetId && (
        <div className="overlay" role="dialog" aria-modal="true">
          <div className="modal-card">
            ...
            <div className="modal-sub">{profile.childName}{particle(profile.childName, "이", "")}의 퀘스트 화면에 보일 짧은 이유를 남겨주세요.</div>
            <textarea
